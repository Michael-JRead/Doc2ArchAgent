...
def validate(system_path: str, networks_path: str | None = None,
    ...
    try:
        ...
        return {
            "valid": False,
            "errors": [{"message": f"System YAML not found: {system_path}", "rule_id": "ARCH001", "file": system_path}],
            "warnings": [],
        }
    except PermissionError:
        return {
            "valid": False,
            "errors": [{"message": f"Permission denied reading: {system_path}", "rule_id": "ARCH001", "file": system_path}],
            "warnings": [],
        }
    except yaml.YAMLError as e:
        return {
            "valid": False,
            "errors": [{"message": f"Invalid YAML in {system_path}: {e}", "rule_id": "ARCH001", "file": system_path}],
            "warnings": [],
        }
